...
# else:unix: LIBS += -L$$OUT_PWD/libs/ -lqtfindreplacedialog
...
# win32-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$OUT_PWD/libs/libqtfindreplacedialog.a
# else:win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$OUT_PWD/libs/libqtfindreplacedialogd.a
# else:win32:!win32-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$OUT_PWD/libs/qtfindreplacedialog.lib
# else:win32:!win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$OUT_PWD/libs/qtfindreplacedialogd.lib
# else:unix: PRE_TARGETDEPS += $$OUT_PWD/libs/libqtfindreplacedialog.a
